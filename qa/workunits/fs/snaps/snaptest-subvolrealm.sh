...
csum_volumes=$(checksum_dir "$GROUP")
csum_snap_volumes=$(checksum_dir "$GROUP/.snap/group_snap")
...
verify_checksum "$csum_root" "$csum_snap_root" "root" "before write"
verify_checksum "$csum_volumes" "$csum_snap_volumes" "volumes" "before write"
...
verify_checksum "$csum_root" "$csum_snap_root" "root" "after write"
verify_checksum "$csum_volumes" "$csum_snap_volumes" "volumes" "after write"
...
csum_volumes1=$(checksum_dir "$GROUP")
csum_snap_volumes1=$(checksum_dir "$GROUP/.snap/group_snap1")
...
# Verify snapshot checksums before write
verify_checksum "$csum_root1" "$csum_snap_root1" "root" "before write, second snap with hardlink/rename"
verify_checksum "$csum_volumes1" "$csum_snap_volumes1" "volumes" "before write, second snap with hardlink/rename"
