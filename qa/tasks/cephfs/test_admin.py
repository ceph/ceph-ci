...
class TestFsAuthorize(CephFSTestCase):
    ...
    def test_multifs_rootsquash_nofeature(self):
        ...
        #self.captester = CapTester(self.mount_b, '/')
        ...
        # should succeed
        with self.assert_cluster_log(f"report clients with broken root_squash", present=False):
            keyring_path = self.mount_a.client_remote.mktemp(data=keyring)
    ...
    def test_rootsquash_nofeature(self):
        ...
        # should succeed
        with self.assert_cluster_log(f"with broken root_squash implementation"):
            keyring_path = self.mount_a.client_remote.mktemp(data=keyring)
