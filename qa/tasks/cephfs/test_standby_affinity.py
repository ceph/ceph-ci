...
class TestStandbyAffinity(CephFSTestCase):
    ...
    def test_standby_affinity_promotion(self):
        ...
        # Trigger the Failover via rank slot eviction for framework execution consistency
        log.info(f"Evicting active rank slot 0 to evaluate promotion standby affinity...")
