 ...
 *
 * @p channel pins delivery when non-null (e.g. the submit reactor captured
 * when the ObjectRequest was created). When null, the caller's current channel
 * is used, matching the historical bind-time capture.
