...
struct AioCompletion {
  ...
  /**
   * ContextWQ channel of the thread that started this I/O (e.g. the SPDK
   * submit reactor). Retained so later stages that run off that thread
   * (object-map callbacks, msgr completions) can still deliver work back
   * to the submit channel.
   */
