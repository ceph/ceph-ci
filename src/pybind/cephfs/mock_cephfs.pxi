...
cdef nogil:
    ...
    int ceph_close_snapdiff(ceph_snapdiff_info *snapdiff):
        pass
    int ceph_open_blockdiff(ceph_mount_info *cmount, const char *root_path, const char *rel_path, const char *snap1, const char *snap2, ceph_file_blockdiff_info *out_info):
        pass
    int ceph_read_blockdiff(ceph_file_blockdiff_info *info, ceph_file_blockdiff_changedblocks *blocks):
        pass
    void ceph_free_file_blockdiff_buffer(ceph_file_blockdiff_changedblocks *blocks):
        pass
    int ceph_close_blockdiff(ceph_file_blockdiff_info *info):
        pass
