...
def create_subvol(mgr, fs, vol_spec, group, subvolname, size, isolate_nspace, pool, mode, uid, gid, earmark, case_sensitive, normalization):
    """
    ...
    :param case_sensitive: whether to make the subvolume case sensitive or not
    ...
    subvolume.create(size, isolate_nspace, pool, mode, uid, gid, earmark, case_sensitive, normalization)
