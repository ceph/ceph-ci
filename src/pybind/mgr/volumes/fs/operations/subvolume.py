...
def create_subvol(mgr, fs, vol_spec, group, subvolname, size, isolate_nspace, pool, mode, uid, gid, earmark, case_sensitive):
    """
    ...
    subvolume.create(size, isolate_nspace, pool, mode, uid, gid, earmark, case_sensitive)
