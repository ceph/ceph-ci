...
class OSDService(CephService):
    ...
    def create_from_spec(self, drive_group: DriveGroupSpec, force_apply: Optional[bool] = False) -> str:
        ...
        async def create_from_spec_one(host: str, drive_selection: DriveSelection, force: Optional[bool] = False) -> Optional[str]:
