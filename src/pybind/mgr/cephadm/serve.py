...
class CephadmServe:
    ...
    def _check_daemons(self) -> None:
        ...
        for dd in daemons:
            ...
            if not last_config:
                ...
                _action, _signal = svc_obj.choose_next_action(
                    _scheduled_action,
                    dd.daemon_type,
                    spec,
                    curr_deps=deps,
    ...
    async def _create_daemon(self,
                             ...
                             send_signal_to_daemon: Optional[utils.Signal] = None,
                             ) -> str:
        ...
        with set_exception_subject('service', orchestrator.DaemonDescription(
            ...
            try:
                ...
                if send_signal_to_daemon:
                    daemon_params['send_signal_to_daemon'] = str(
