    ...
    def process_dict(self, input_dict: dict,
        ...
        for field, type_hint in hints.items():
            ...
            if origin is Annotated:
                ...
                # First pass: collect metadata annotations
                ...
                # Second pass: process transformations and special handling
                for annotation in annotations:
                    ...
                    if is_top_level and annotation == CliFlags.EXCLUSIVE_LIST:
                        ...
                        # Check if list is empty and we have a message template
                        if not value and empty_message_template:
                            # Format template with available fields from input_dict and template_context
                    ...
                    if annotation == CliFlags.SIZE:
                        ...
                        object_to_promote = self.process_dict(value, actual_type, False, template_context)
