...
class TestNvmeofCLICommandDeprecatedParams:
    """Tests for the deprecated_params warning mechanism in NvmeofCLICommand."""

    # ------------------------------------------------------------------ helpers

    @staticmethod
    def _make_cmd(test_cmd, deprecated_params=None, alias=None):
        """Register a simple command and return the cmd key."""
        class Model(NamedTuple):
            status: str
        ...
        def fn(self, new_param: str, old_param: Optional[str] = None):  # pylint: disable=unused-variable
            return {'status': 'ok'}
    ...
    def test_deprecated_params_stored_on_instance(self):
        """Mapping passed to constructor is stored as _deprecated_params."""
    ...
    def test_no_deprecated_params_defaults_to_empty_dict(self):
        """Omitting deprecated_params leaves _deprecated_params as empty dict."""
    ...
    def test_none_deprecated_params_defaults_to_empty_dict(self):
        """Passing deprecated_params=None is equivalent to omitting it."""
    ...
    def test_alias_inherits_deprecated_params(self):
        """Alias command receives the same deprecated_params mapping."""
    ...
    def test_alias_without_deprecated_params_has_empty_dict(self):
        """Alias of a command with no deprecated_params also has an empty dict."""
    ...
    # ------------------------------------------------------------------ plain-format warning emission

    def test_warning_emitted_when_deprecated_param_is_supplied(self):
        """Warning line appended to plain output when deprecated param is used."""
    ...
    def test_no_warning_when_deprecated_param_is_absent(self):
        """No Warning line when the deprecated param is not supplied."""
    ...
    def test_no_warning_when_deprecated_params_is_empty(self):
        """No warning emitted on a command with no deprecated_params."""
    ...
    def test_multiple_deprecated_params_each_emit_warning(self):
        """Each deprecated param that is supplied emits its own Warning line."""
    ...
    def test_only_supplied_deprecated_param_warns(self):
        """When only one of two deprecated params is supplied, only that one warns."""
    ...
    # ------------------------------------------------------------------ output format isolation

    def test_warning_not_emitted_for_json_format(self):
        """JSON output is unaffected by deprecated_params."""
    ...
    def test_warning_not_emitted_for_yaml_format(self):
        """YAML output is unaffected by deprecated_params."""
    ...
    def test_warning_emitted_for_explicit_plain_format(self):
        """Explicit 'plain' format also emits warnings."""
    ...
    # ------------------------------------------------------------------ coexistence with error_message warning

    def test_deprecated_warning_and_error_message_warning_both_appear(self):
        """Both the gRPC error_message warning and deprecated param warnings are shown."""
    ...
    def test_error_message_warning_without_deprecated_param(self):
        """error_message warning still works when no deprecated param is supplied."""
    ...
    # ------------------------------------------------------------------ alias emits same warning

    def test_alias_emits_same_warning_as_main_command(self):
        """The alias command emits the same deprecation warning as the main command."""
    ...
    def test_alias_also_suppresses_warning_when_param_absent(self):
        """Alias also produces no warning when deprecated param is not passed."""
    ...
    def test_warning_emitted_on_failure_when_deprecated_param_supplied(self):
        """Warning appears in stderr when the command raises and deprecated param was used."""
    ...
    def test_no_warning_on_failure_when_deprecated_param_absent(self):
        """No warning in stderr when the command raises but deprecated param was not used."""
    ...
    def test_warning_in_stdout_on_success_and_stderr_on_failure(self):
        """Warning lands in stdout on success and stderr on failure — same param, different path."""
        ...
        def fn_ok(self, new_param: str, old_param: Optional[str] = None):  # pylint: disable=unused-variable
            return {'status': 'ok'}
        ...
        def fn_fail(self, new_param: str, old_param: Optional[str] = None):  # pylint: disable=unused-variable
        ...
        try:
            ...
            assert "\nWarning: --old-param is deprecated, please use --new-param" in ok_result.stdout
            ...
            assert "\nWarning: --old-param is deprecated, please use --new-param" in fail_result.stderr
        finally:
            self._cleanup(test_cmd_ok, test_cmd_fail)

    # ------------------------------------------------------------------ success message + warning coexistence

    def test_deprecated_warning_appended_after_success_message(self):
        """Warning is appended after a success_message_template, not instead of it."""
    ...
    def test_no_warning_appended_to_success_message_when_param_absent(self):
        """Success message is clean when deprecated param is not supplied."""
