...
class TestNamespaceListHosts:
    def test_non_empty_hosts_renders_table(self):
                ...
                'namespaces': [
                    {
                        ...
                        'nsid': 1,
                        'hosts': ['nqn.2014-08.org.nvmexpress:uuid:8d78a673-8b0f-4228-ae7e-89f5fd5c3a74'],
                    }
                ],
            }
        ...
        try:
            ...
            assert isinstance(result, HandleCommandResult)
            assert result.retval == 0
            assert 'nqn.2014-08.org.nvmexpress:uuid:8d78a673-8b0f-4228-ae7e-89f5fd5c3a74' in result.stdout
