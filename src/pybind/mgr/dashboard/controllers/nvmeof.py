...
try:
    ...
    class NVMeoFNamespace(RESTController):
        ...
        @NvmeofCLICommand("nvmeof ns set_qos")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def set_qos(self, 
            nqn: str, 
            ...
            return NVMeoFClient().stub.namespace_set_qos_limits(
        ...
        @ReadPermission
        @Endpoint('GET', '{nsid}/change_load_balancing_group')
        @EndpointDoc(
        ...
        @NvmeofCLICommand("nvmeof ns change_load_balancing_group")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def change_load_balancing_group(self, 
            nqn: str,
            nsid: str,
            load_balancing_group: Optional[int] = None,
            gw_group: Optional[str] = None,
            ...
            return NVMeoFClient().stub.namespace_change_load_balancing_group(
        ...
        @NvmeofCLICommand("nvmeof ns resize")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def resize(self,
            nqn: str,
        ...
        @EndpointDoc(
            ...
            parameters={
                ...
                "force": Param(bool, "Force add host"),
                "gw_group": Param(str, "NVMeoF gateway group", True, None),
                "traddr": Param(str, "NVMeoF gateway address", True, None),
            },
        )
        @NvmeofCLICommand("nvmeof ns add_host")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def add_host(self, 
            nqn: str,
        ...
        @NvmeofCLICommand("nvmeof ns del_host")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def del_host(self,
            nqn: str,
            ...
            return NVMeoFClient(gw_group=gw_group, traddr=traddr).stub.namespace_delete_host(
                NVMeoFClient.pb2.namespace_delete_host_req(subsystem_nqn=nqn,
                                                        nsid=int(nsid),
                                                        host_nqn=host_nqn
                )
            )
        ...
        @ReadPermission
        @Endpoint('GET', '{nsid}/change_visibility')
        @EndpointDoc(
        ...
        @NvmeofCLICommand("nvmeof ns change_visibility")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def change_visibility(self,
            ...
            return NVMeoFClient(gw_group=gw_group, traddr=traddr).stub.namespace_change_visibility(
                NVMeoFClient.pb2.namespace_change_visibility_req(subsystem_nqn=nqn,
                                                        nsid=int(nsid),
        ...
        @ReadPermission
        @Endpoint('GET', '{nsid}/set_rbd_trash_image')
        @EndpointDoc(
        ...
        @NvmeofCLICommand("nvmeof ns set_rbd_trash_image")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def set_rbd_trash_image(self,
            nqn: str,
            nsid: str,
            ...
            return NVMeoFClient(gw_group=gw_group, traddr=traddr).stub.namespace_set_rbd_trash_image(
        ...
        @ReadPermission
        @Endpoint('GET', '{nsid}/set_auto_resize')
        @EndpointDoc(
            "changes the auto resize flag for the specified NVMeoF namespace to all or selected hosts",
            parameters={
                "nqn": Param(str, "NVMeoF subsystem NQN"),
                "nsid": Param(str, "NVMeoF Namespace ID"),
                "auto_resize_enabled": Param(bool, 'True if active'),
                "gw_group": Param(str, "NVMeoF gateway group", True, None),
                "traddr": Param(str, "NVMeoF gateway address", True, None),
            },
        )
        @NvmeofCLICommand("nvmeof ns set_auto_resize")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
        def set_auto_resize(self,
            nqn: str,
            nsid: str,
            auto_resize_enabled: str,
            gw_group: Optional[str] = None,
            traddr: Optional[str] = None
        ):
        ...
        @ReadPermission
        @Endpoint('GET', '{nsid}/refresh_size')
        @EndpointDoc(
        ...
        @NvmeofCLICommand("nvmeof ns refresh_size")
        @convert_to_model(model.RequestStatus)
        @handle_nvmeof_error
