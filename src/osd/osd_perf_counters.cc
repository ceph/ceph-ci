...
PerfCounters *build_osd_logger(CephContext *cct) {
  ...
  osd_plb.add_u64_counter(l_osd_full_map_received, "full_map_received", "number of full OSD map recieved via MOSDMap");
  osd_plb.add_u64_counter(l_osd_inc_map_received, "inc_map_received", "number of incremental OSD map recieved");
