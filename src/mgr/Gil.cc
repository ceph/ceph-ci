...
static const uint64_t gil_fixed_threshold_ns = 2000000;
                             ...
                             std::chrono::nanoseconds wait_duration)
{
  ...
  // PerfCounters::read_avg() returns {sum, count}, not {count, sum}.
  ...
  if (wait_ns > dynamic_threshold || wait_ns > gil_fixed_threshold_ns) {
    dout(10) << what << ": module '" << gil_thread_module_name
             ...
             << dendl;
    dout(10) << what << ": backtrace: " << ClibBackTrace(0) << dendl;
  }
}
