...
class Object {
  public:
    ...
    /** set expiry date for restore object */
    virtual int set_cloud_expiry_days(const DoutPrefixProvider* dpp, optional_yield y, std::optional<uint64_t> modified_days) = 0;
