...
void SSDDriver::LibaioAsyncWriteRequest::libaio_write_cb(sigval sigval) {
    ...
    ldpp_dout(op.dpp, 20) << "INFO: LibaioAsyncWriteRequest::libaio_write_yield_cb: new_path: " << op.file_path << dendl;
    ldpp_dout(op.dpp, 20) << "INFO: LibaioAsyncWriteRequest::libaio_write_yield_cb: old_path: " << op.temp_file_path << dendl;
