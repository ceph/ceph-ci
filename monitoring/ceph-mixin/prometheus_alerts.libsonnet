    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          labels: { severity: 'warning', type: 'ceph_default' },
          annotations: {
            summary: 'The number of subsystems defined to the gateway reached supported values%(cluster)s' % $.MultiClusterSummary(),
        ...
        },
        {
          ...
          labels: { severity: 'warning', type: 'ceph_default' },
          annotations: {
            summary: 'The number of namespaces defined to the gateway reached supported values%(cluster)s' % $.MultiClusterSummary(),
